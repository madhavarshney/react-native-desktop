...
function applyDesktopPlatformPatch() {
  exec('git apply --reverse ./node_modules/react-native/patches/metro-config+0.49.2.patch');
  exec('git apply ./node_modules/react-native/patches/metro-config+0.49.2.patch', (err, stdout, stderr) => {
